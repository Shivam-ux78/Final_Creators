...
def process_candidate(cand: dict) -> dict:
    ...
    try:
        ...
        return {
            ...
            "followers_num": f_num,
            "category": cand.get("category", "Lifestyle") or "Lifestyle",
            "location": loc,
            "biography": biography,
...
def main():
    print("=" * 70, flush=True)
    print("🚀 FINDING FINAL 3 USA CREATORS (100K-500K)")
    print("=" * 70, flush=True)
    ...
    # Search through multiple discovery URLs
    discovery_urls = [
        # Collabstr search pages with followers
        ...
        "https://collabstr.com/influencers?c=Lifestyle&pg=",
        "https://collabstr.com/influencers?c=Family+%26+Children&pg=",
        "https://collabstr.com/influencers?c=Travel&pg=",
        "https://collabstr.com/influencers?c=Food+%26+Drink&pg=",
        "https://collabstr.com/influencers?c=Comedy+%26+Entertainment&pg="
    ]
