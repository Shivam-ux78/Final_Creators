...
OUTPUT_JSON = os.path.join("data", "extracted_100_brand_new_couples_batch4.json")
OUTPUT_CSV = os.path.join("data", "extracted_100_brand_new_couples_batch4.csv")
OUTPUT_XLSX = os.path.join("data", "extracted_100_brand_new_couples_batch4.xlsx")
...
def main():
    print("=" * 70, flush=True)
    print("🚀 EXTRACTING NEW 100 USA COUPLE CREATORS (<500K FOLLOWERS | BATCH 4)")
    print("=" * 70, flush=True)
    ...
    print("\n" + "=" * 70, flush=True)
    print(f"✨ SUCCESS: Extracted {len(final_100)} brand new USA couple creators (<500k followers)!", flush=True)
