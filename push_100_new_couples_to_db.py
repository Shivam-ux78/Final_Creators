...
json_path = os.path.join("data", "extracted_100_new_couples_100k_400k_usa.json")
...
print("=" * 70)
print("🚀 PUSHING 100 NEW COUPLE CREATORS (100K-400K | USA) TO SUPABASE")
print("=" * 70)
...
print("=" * 70)
print(f"🎉 SUCCESS: {uploaded} / {len(clean_records)} New Couple Creators pushed to Supabase!")
